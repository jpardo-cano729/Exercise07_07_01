...
var pokerGame = {
  ...
  // Constructor fucntion for poker cards
...
/* Method to preference the image source file for a card*/
...
pokerHand.prototype.hasSets = function(){
      // hasSets summarizes the duplicates in the hand
      var handSets = {};
      ...
      for (var cardRank in handSets) {
          ...
          if (handSets[cardRank] === 3) {
              if (sets === "Pair") { sets = "Full House"; } else { sets = "Three of a Kind"; }
          }
          if (handSets[cardRank] === 2) {
              if (sets === "Three of a Kind") { sets = "Full House"; } else if (sets === "Pair") { sets = "Two Pair"; } else { sets = "Pair";
                  pairRank = cardRank; }
          }
      }
...
pokerHand.prototype.handType = function() {
      if (this.hasRoyalFlush()) { return "Royal Flush"; } else if (this.hasStraightFlush()) { return "Straight Flush"; } else if (this.hasFlush()) { return "Flush"; } else if (this.hasStraight()) { return "Straight"; } else {
